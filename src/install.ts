...
export interface Modifier {
  ...
  modifyValue<Self, Prop extends keyof Self> (obj: Self, prop: Prop, getNewValue: (api: ModifyValueAPI<Self[Prop]>) => Self[Prop]): void
  modifyReturned<Self, Prop extends keyof Self, Fn extends (Self[Prop] extends (...args: any[]) => any ? Self[Prop] : never)> (obj: Self, prop: Prop, filter: (api: ModifyReturnedAPI<Self, Fn>) => ReturnType<Fn>): void
  modifyGetter<Obj, Self extends NonNullable<Obj>, Prop extends keyof Self, Value extends Self[Prop]> (obj: Obj, prop: Prop, newGetter: (api: ModifyGetterAPI<Self, Value>) => Value): void
}
...
export interface ModifyReturnedAPI<Self, Fn extends (...args: any) => any> {
  self: Self,
  originalFunction: Fn,
...
interface RootState {
  ...
  readonly mimicFunctions: WeakMap<Function, Function>
}
...
export function install (scope: Scope) {
  ...
  function createMimicFunction (originalFunction: (...args: any[]) => any, newFunction: (...args: any[]) => any) {
    const { mimic } = {
      mimic(...args: any[]) {
  ...
  const mimicFunctionToString = createMimicFunction(originalFunctionToString, function (this: Function) {
    ...
    modifyValue(obj, prop, (api) => {
      return function (this: any, ...originalArgs: any[]) {
        ...
        return filter({
          ...
          originalReturned: (api.originalValue as (...args: any[]) => any).call(this, ...originalArgs),
